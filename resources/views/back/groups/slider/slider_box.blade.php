<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            <label>Изображение (1120х520)</label>
            <div class="dropzone">
                        ...
                        <div class="input-group file-caption-main">
                            ...
                            <div class="file-preview-frame">
                                <div class="kv-file-content">
                                    <img src="{{$item->slide_field->link}}" class="kv-preview-data file-preview-image" title="{{$item->slide_field->alt}}" alt="{{$item->slide_field->alt}}" style="width:auto;height:160px;">
                                </div>
                                <div class="file-thumbnail-footer">
                                    <div class="file-footer-caption" title="{{$item->slide_field->alt}}"></div>
                                    <div class="file-actions">
                                        <input type="text" class="form-control alt-text" data-block="slider" data-type="images" data-id="{{$item->id_field}}" data-name="alt" value="{{$item->slide_field->alt}}" placeholder="Alt-текст">
