<tr role="row" class="odd" data-id="{{$item->id_field}}">
    ...
    {{-- Название  --}}
    <td class="sorting_1">
        <a href="clients/{{$item->id_field}}" class="">{{$item->client_name_field}}</a>
    </td>
    ...
    {{-- Удаления  --}}
    <td>
        <button type="button" class="btn btn-block btn-primary group-remove-item" data-id="{{$item->id_field}}" data-block="client">Удалить</button>
    </td>
</tr>